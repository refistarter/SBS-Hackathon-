                        ...
                        <div class="row g-5 align-items-center">
                                ...
                                <div class="pro-details__item-wrap">
                                    <div class="pro-details__item">
                                        <div class="pro-details__item-thumb">
                                            <img src="/images/igo/author/1.png" alt="IGO Project">
                                        </div>
                                        <div class="pro-details__item-content">
                                            <h4>Dexer Xone <span>(Bzon)</span></h4>
                                    ...
                                    <div class="btn-group mt-4 d-flex flex-wrap gap-20">
                                        <nuxt-link to="/account/login"
                                            class="default-btn default-btn--small"><span>Claim
                                                Token</span></nuxt-link>
                                        <a href="/account/signup"
                                            class="default-btn default-btn--small default-btn--secondary"><span>Register
                                                Now</span></a>
                                    </div>
                            ...
                            <div class="col-lg-5">
                                <div class="pro-details__info">
                                    <div class="row g-3">
                                        <div v-for="(item, index) in infolist" :key="index" class="col-sm-6">
                            ...
                            <div class="pro-details__desc-content">
                                <div data-bs-spy="scroll" data-bs-target="#pro-details-navlist"
                                    ...
                                    <section id="pro-details-about">
                                        <h4>About TorkGo</h4>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio animi, id
                                            ducimus eum tempora minus labore saepe fuga eius dolor non veritatis
                                            excepturi perferendis molestiae nulla quia officiis sunt soluta.</p>
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laborum dolores
                                            alias aliquid iusto eaque perferendis.</p>
                                        <div class="pro-details__img my-4">
                                            <img src="/images/blog/single/01.jpg" alt="Project Image">
                                        </div>

                                        <h5>Metaverse</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Soluta, debitis
                                            tenetur dolorem a ab voluptas dolore nesciunt saepe optio amet temporibus
                                            ipsum beatae est quisquam.</p>
                                        <div class="pro-details__img my-4">
                                            <img src="/images/blog/single/02.jpg" alt="Project Image">
                                        </div>
                                    </section>
                                    ...
                                    <section id="pro-details-token">
                                        ...
                                        <div class="pro-details__token-info mt-4">
                                            ...
                                            <ul class="pro-details__tokenlist">
                                                <li class="pro-details__tokenlist-item"><i
                                                        class="fa-solid fa-dice-d6"></i>
                                                    Lorem ipsum dolor sit amet.</li>
                                                <li class="pro-details__tokenlist-item"><i
                                                        class="fa-solid fa-dice-d6"></i>
                                                    Opsum dolor sit amet.</li>
                                                <li class="pro-details__tokenlist-item"><i
                                                        class="fa-solid fa-dice-d6"></i>
                                                    Dolor sit amet.</li>
                                                <li class="pro-details__tokenlist-item"><i
                                                        class="fa-solid fa-dice-d6"></i>
                                                    Zit amet Lorem, ipsum.</li>
                                                <li class="pro-details__tokenlist-item"><i
                                                        class="fa-solid fa-dice-d6"></i>
                                                    Xmet dio lor em.</li>
                                                <li class="pro-details__tokenlist-item"><i
                                        ...
                                        <div class="pro-details__img my-4">
                                            <img src="/images/blog/single/03.jpg" alt="Token Image">
                                        </div>
                                    </section>
                                    ...
                                    <section id="pro-details-roadmap">
                                        ...
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laborum dolores
                                            alias aliquid iusto eaque perferendis.</p>
                                        <div class="pro-details__img my-4">
                                            <img src="/images/blog/single/04.jpg" alt="roadmap Image">
                                        </div>
                                    ...
                                    <section id="pro-details-backers">
                                        ...
                                        <div class="pro-details__img my-4">
                                            <img src="/images/blog/single/05.jpg" alt="Project Image">
                                        </div>
                                ...
                                <div class="pro-details__desc-nav">
                                    ...
                                    <div class="list-group bg--primary-color mb-4" id="pro-details-navlist">
                                        ...
                                        <a class="list-group-item list-group-item-action" href="#pro-details-token"> <i
                                                class="fa-solid fa-diagram-project"></i> Token</a>
                                        <a class="list-group-item list-group-item-action" href="#pro-details-roadmap">
                                            <i class="fa-solid fa-road"></i> Roadmap</a>
                                    ...
                                    <div class="pro-details__links">
                                        ...
                                        <div class="pro-details__links-item">
                                            ...
                                            <div class="pro-details__links-content">
                                                <a class="pro-details__links-btn" href="#">www.example.com <span><i
                                        ...
                                        <div class="pro-details__links-item">
                                            ...
                                            <div class="pro-details__links-content">
                                                <a class="pro-details__links-btn" href="#">Whitepaper <span><i
...
export default {
    ...
    setup() {
        ...
        layoutStore.assignLayoutData({ title: 'Project Details', subtitle: "Project details" })
        return {}
    },
    head() {
        return {
